...
function user-configure-iterm2()
{
    ...
    local -a option_set=(
        "AlternateMouseScrollStringForDown -string \\x5\\x5\\x5"
        "AlternateMouseScrollStringForUp -string \\x19\\x19\\x19"
...
function user-misc-gui-tweaks()
{
    ...
    # Disable font smoothing to restore appearance pre-Mojave fonts on
    # non-retina displays.
