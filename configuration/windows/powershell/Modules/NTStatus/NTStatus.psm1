...
#
# These are duplicate mappings that were elided in favor of more common
# interpretations:
#
...
function Get-NTStatusName
{
    <#
    .SYNOPSIS
        Convert a numeric NTSTATUS code to a string.

    .DESCRIPTION
        This function is used to map numeric NTSTATUS values to associated
        string. If a particular NTSTATUS value is no recognized, this function
        returns `$null`. There are three values that are elided from this table
        because their numeric values have multiple meanings. The most commonly
        used description is what was chosen for the table. The elided values
        are:
        - 0x00000000: STATUS_WAIT_0
        - 0x00000080: STATUS_ABANDONED_WAIT_0
        - 0xC0220018: STATUS_FWP_TOO_MANY_BOOTTIME_FILTERS
    ...
    return $NTStatusNames[$Status]
}

Export-ModuleMember -Function Get-NTStatusName
