...
static void usage(const char *self)
{
    printf(
        ...
        "           Supplementary clocks are only shown if they differ from\n"
        "           the clock for the system's default time zone. This flag\n"
        "           can be specified multiple times to show multiple clocks,\n"
        "           and the clocks will be shown in the order they appear on\n"
        "           the command line followed by the primary clock. If this\n"
